...
public class BigInteger {
    ...
    public static void main(String[] args) {
        ...
        while (scan.hasNextLine()) {
            ...
            if (input.length() != 0 && input.charAt(0) != '#') {
                ...
                try {
                    //if there are too many strings in the array
                    ...
                    inputs.add(new InputScenario(ZERO,ZERO, " ", false, input));
                }
            }
        }
        scan.close();
        ...
        for (InputScenario i : inputs) {
            if (i.isValid) {
                switch (i.operation) {
                    case "+":
                        System.out.println(BigInteger.toString(i.a) + " + " + BigInteger.toString(i.b));
                        System.out.println("# " + BigInteger.toString(BigInteger.add(i.a, i.b)) + "\n");
                        break;
                    case "-":
                        System.out.println(BigInteger.toString(i.a) + " - " + BigInteger.toString(i.b));
                        System.out.println("# " + BigInteger.toString(BigInteger.subtract(i.a, i.b)) + "\n");
                        break;
                    case "*":
                        System.out.println(BigInteger.toString(i.a) + " * " + BigInteger.toString(i.b));
                        System.out.println("# " + BigInteger.toString(BigIntegerExtension.multiply(i.a, i.b)) + "\n");
                        break;
                    case "/":
                        System.out.println(BigInteger.toString(i.a) + " / " + BigInteger.toString(i.b));
                        BigInteger[] divResult = BigIntegerExtension.divide(i.a, i.b);
                        System.out.println("# " + BigInteger.toString(divResult[0]) + " " + BigInteger.toString(divResult[1]) + "\n");
                        break;
                    case "gcd":
                        System.out.println(BigInteger.toString(i.a) + " gcd " + BigInteger.toString(i.b));
                        System.out.println("# " + BigInteger.toString(BigIntegerExtension.gcd(i.a, i.b)) + "\n");
                        break;
                    case "<":
                        System.out.println(BigInteger.toString(i.a) + " < " + BigInteger.toString(i.b));
                    ...
                    case "=":
                        ...
                        break;
                    default:
                        System.out.println(BigInteger.toString(i.a) + i.operation + BigInteger.toString(i.b));
    ...
    public BigInteger(String number) {
        ...
        //reverse string so least significant numbers are at the start of the array
    ...
    public static BigInteger subtract(BigInteger a, BigInteger b) {
        ...
        if (a.sign == -1 && b.sign == -1) {
            //add negative sign
            return BigInteger.subtract(new BigInteger(b.digits, 1), new BigInteger(a.digits, 1));
        } else if (a.sign == -1 && b.sign == 1) {
        ...
        //remove leading zeros
        if (resultDigits[resultDigits.length - 1] == 0) {
            resultDigits = Arrays.copyOfRange(resultDigits, 0, resultDigits.length - 1);
        }
    ...
    public static int compareTo(BigInteger a, BigInteger b) {
        ...
        if (a.digits.length > b.digits.length) {
            ...
            int count = 0;
            while (a.digits[a.digits.length - 1 - count] == b.digits[b.digits.length - 1 - count]) {
            ...
            if (a.digits[a.digits.length - 1 - count] > b.digits[b.digits.length - 1 - count]) {
                return 1;
            } else {
                return -1;
            }
...
class BigIntegerExtension {
    ...
    public static BigInteger multiply(BigInteger a, BigInteger b) {
        int sign = BigInteger.compareTo(a, ZERO) * BigInteger.compareTo(b, ZERO);
        int bSign = BigInteger.compareTo(b, ZERO);

        BigInteger result = ZERO;

        //define addition through adding a to result b times
        for (int i = 0; BigInteger.compareTo(b, new BigInteger(Integer.toString(i))) == bSign; i += BigInteger.compareTo(b, new BigInteger(Integer.toString(i)))) {
    ...
    public static BigInteger[] divide(BigInteger a, BigInteger b) {
        int resultSign = (BigInteger.compareTo(a, ZERO) * BigInteger.compareTo(b, ZERO));
    ...
    public static BigInteger gcd(BigInteger a, BigInteger b) {
        ...
        while (BigInteger.compareTo(start, ZERO) == 1) {
            ...
            if (BigInteger.compareTo(aResult[1], ZERO) == 0 && BigInteger.compareTo(bResult[1], ZERO) == 0) {
                return start;
            }
...
class InputScenario {
    ...
    public InputScenario(BigInteger a, BigInteger b, String op, Boolean isValid, String invalid) {
        this.a = a;
        this.b = b;
        this.operation = op;
